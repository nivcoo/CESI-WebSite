        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('panel_offers_add') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="society_id">
                                    @foreach($get_societies as $value)
                                        <option value="{{$value->id}}">{{$value->name}} | {{$value->address}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input value="<?= date('Y-m-d') ?>" data-target="#datetimepicker-start"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input value="<?= date('Y-m-d') ?>" data-target="#datetimepicker-end"
                                           data-toggle="datetimepicker" type="text" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input value="<?= date('Y-m-d') ?>" data-target="#datetimepicker-archived"
                                           data-toggle="datetimepicker" type="text" class="form-control"
